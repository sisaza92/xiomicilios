...
namespace Datos
{
    public class Cliente
    {
        public void InsertarCliente(Entidades.Cliente cliente)
        {
            ...
            parametroNombre.Value = cliente.NombreUsuario;
            ...
            cmd.Parameters.Add(new SqlParameter("@idUsuario", cliente.IdUsuario));
            ...
            cmd.Parameters.Add(new SqlParameter("@activoUsuario", cliente.ActivoUsuario));
            cmd.Parameters.Add(new SqlParameter("@telefono", cliente.Telefono));
            cmd.Parameters.Add(new SqlParameter("@fechaUsuario", cliente.FechaUsuario));
